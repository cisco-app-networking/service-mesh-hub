...
var IssuedCertificateSpec_TlsType_name = map[int32]string{
	0: "SHARED",
	1: "LIMITED",
}

var IssuedCertificateSpec_TlsType_value = map[string]int32{
	"SHARED":  0,
	"LIMITED": 1,
}

func (x IssuedCertificateSpec_TlsType) String() string {
	return proto.EnumName(IssuedCertificateSpec_TlsType_name, int32(x))
}

func (IssuedCertificateSpec_TlsType) EnumDescriptor() ([]byte, []int) {
...
type IssuedCertificateSpec struct {
	...
	// Type of certificate to be used for security
	TlsType              IssuedCertificateSpec_TlsType `protobuf:"varint,6,opt,name=tls_type,json=tlsType,proto3,enum=certificates.mesh.gloo.solo.io.IssuedCertificateSpec_TlsType" json:"tls_type,omitempty"`
...
func (m *IssuedCertificateSpec) GetTlsType() IssuedCertificateSpec_TlsType {
	if m != nil {
		return m.TlsType
	}
	return IssuedCertificateSpec_SHARED
}
...
func init() {
	proto.RegisterEnum("certificates.mesh.gloo.solo.io.IssuedCertificateSpec_TlsType", IssuedCertificateSpec_TlsType_name, IssuedCertificateSpec_TlsType_value)
...
var fileDescriptor_86ade12c22739639 = []byte{
	...
	,
}
